...
// UN Peace and Security focused posts
const posts = [
  // YouTube posts
  {
  ...
  // Original posts with UN imagery
  {
...
async function seedPeaceSecurity() {
  try {
    ...
    console.log(`Created ${posts.length} UN Peace and Security posts`);
    console.log('\nPost breakdown:');
    console.log('- YouTube: 4 posts');
    console.log('- Twitter/X: 3 posts');
    console.log('- Instagram: 2 posts');
    console.log('- Original: 6 posts');
    console.log('\nAll posts approved and ready to display!');
