...
async function seed() {
  try {
    ...
    await Post.bulkCreate([
      ...
      {
        title: 'Secretary-General\'s Address on Global Peace',
      ...
      },
      {
        ...
        content: '<p>September 21st marks the International Day of Peace. This year, communities worldwide are organizing events promoting dialogue and reconciliation.</p><p>"Peace is not merely the absence of war, but the presence of justice." - UN Charter</p>',
        status: 'approved',
        sourceType: 'original',
        sortOrder: 6,
        authorId: admin.id
      ...
      // Pending posts (from regular user)
      {
